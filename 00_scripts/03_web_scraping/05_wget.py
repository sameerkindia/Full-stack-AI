...
def sanitize_filename(title):
    ...
    # 1. Sirf Alphanumeric characters, spaces, hyphens aur underscores ko allow karein
    clean_title_char = re.sub(r'[^\w\s-]', '', title)
    # 2. Spaces ko single underscore se replace karein
    clean_title = re.sub(r'[\s]+', '_', clean_title_char)
